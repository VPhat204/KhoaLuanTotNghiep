    ...
    <div className="teacher-overview-page">
      ...
      <div className="teacher-dashboard-top-section">
        <div className="teacher-left-sidebar">
          ...
          <Card 
            className="teacher-chart-card" 
            title={
              <div className="teacher-card-title-with-toggle">
                {t('recentActivity')}
                <button 
                  className="teacher-card-collapse-toggle"
                  onClick={() => setActivityCollapsed(!activityCollapsed)}
                  title={activityCollapsed ? t('expand') : t('collapse')}
                >
                  {activityCollapsed ? <CaretDownOutlined /> : <CaretUpOutlined />}
                </button>
              </div>
            }
          >
        ...
        <div className={`teacher-calendar-section ${calendarCollapsed ? 'teacher-calendar-collapsed' : ''}`}>
          <button 
            className="teacher-calendar-collapse-toggle"
            onClick={() => setCalendarCollapsed(!calendarCollapsed)}
            title={calendarCollapsed ? t('expand') : t('collapse')}
          >
            {calendarCollapsed ? <DownOutlined /> : <UpOutlined />}
          </button>
      ...
      <div className="teacher-dashboard-bottom">
        <Card 
          ...
          extra={
            <div className="teacher-card-extra-actions">
