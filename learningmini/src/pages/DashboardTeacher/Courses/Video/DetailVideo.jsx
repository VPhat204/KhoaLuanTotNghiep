...
export default function CourseDetail({ course }) {
  ...
  const handleSubmitReply = async (parentComment) => {
    if (!replyContent.trim()) return message.warning(t('translation.replyRequired'));
  ...
  const tabItems = [
    {
      ...
      children: (
        <>
          ...
          <Paragraph className="course-detail-teacher-description">{course.description || t('translation.courseDetail.noDescription')}</Paragraph>
        </>
      ),
    },
    {
      ...
      children: (
        <div className="course-detail-teacher-list-container">
          ...
          {videos.length > 0 ? (
            ...
            <Paragraph className="course-detail-teacher-empty-state">{t('translation.courseDetail.noVideos')}</Paragraph>
          )}
        </div>
      ),
    },
        ...
        <div className="course-detail-teacher-comments-section">
          ...
          <div className="course-detail-teacher-comments-tree">
            {commentsTree.length > 0 ? (
              ...
              <Paragraph className="course-detail-teacher-empty-state">{t('translation.courseDetail.noComments')}</Paragraph>
            )}
          </div>
