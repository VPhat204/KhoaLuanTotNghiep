...
export default function CourseDetail({ course }) {
  ...
  const fetchVideos = useCallback(async () => {
    if (!course?.id) return;
    try {
      const res = await axios.get(`https://khoaluantotnghiep-i5m4.onrender.com/videos/${course.id}`);
      setVideos(res.data);
    } catch {
  ...
  const fetchComments = useCallback(async () => {
    ...
    try {
      const res = await axios.get(
        `https://khoaluantotnghiep-i5m4.onrender.com/comments/${course.id}`,
  ...
  const fetchStudentCount = useCallback(async () => {
    if (!course?.id) return;
    try {
      const res = await axios.get(`https://khoaluantotnghiep-i5m4.onrender.com/courses/${course.id}/students-count`);
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      await axios.post(
        "https://khoaluantotnghiep-i5m4.onrender.com/comments/add",
        commentData,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleUpdateComment = async () => {
    ...
    try {
      await axios.put(
        `https://khoaluantotnghiep-i5m4.onrender.com/comments/${editingComment.id}`,
        { content: editContent },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleDeleteComment = async () => {
    ...
    try {
      await axios.delete(
        `https://khoaluantotnghiep-i5m4.onrender.com/comments/${commentToDelete.id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
